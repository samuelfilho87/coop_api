...
//    }
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.csrf().disable()
			.authorizeRequests()
				.antMatchers(HttpMethod.POST, "/api/dadosOng/**", "/api/publicacao/**", "/api/usuarios/**", "/api/enderecos", "/api/doacao", "/api/doacao/alterar-status/**", "/api/ongs/**", "/api/imagem/**", "/storage/**")
					.permitAll()
				.antMatchers(HttpMethod.GET, "/api/publicacao/**", "/api/enderecos/**", "/api/doacao/**", "/api/ongs/**", "/api/dadosOng/**", "/api/itensOng/**", "/api/imagem/**")
					.permitAll()
				.antMatchers(HttpMethod.PUT, "/api/publicacao/**", "/api/ongs/**", "/api/doacao/**", "/api/usuarios/**", "/api/imagem/**")
					.permitAll()
				.antMatchers(HttpMethod.DELETE, "/api/publicacao/**", "/api/doacao/**", "/storage/**") 
				    .permitAll()		
